...
function rg_enqueue_scripts_styles() {
	...
	wp_enqueue_style( 'rg-fonts', '//fonts.googleapis.com/css?family=Taviraj:300,500,800', array(), CHILD_THEME_VERSION );
	wp_enqueue_style( 'rg2-fonts', '//fonts.googleapis.com/css?family=Supermercado+One', array(), CHILD_THEME_VERSION );
